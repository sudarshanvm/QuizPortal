...
if (@$_GET['q'] == 0) {
    ...
    <td style="vertical-align:middle"><b>Course Title</b></td>
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $status  = $row['status'];
        if ($status == "enabled") {
            echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $coursetitle . '</td><td style="vertical-align:middle">' . $coursecode . '</td><td style="vertical-align:middle">' . $sem . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;min</td><td style="vertical-align:middle">Enabled</td>
...
<td style="vertical-align:middle"><b>USN</b></td>
...
<td style="vertical-align:middle"></td></tr>';
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $name . '</td><td style="vertical-align:middle">' . $usn . '</td><td style="vertical-align:middle">' . $branch . '</td><td style="vertical-align:middle">' . $email . '</td><td style="vertical-align:middle">' . $sem . '</td>
  <td style="vertical-align:middle"><a title="Delete User" href="update.php?dusername=' . $name . '"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
    }
    $c = 0;
    echo '</table></div>';
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Branch</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Roll number</b></td><td style="vertical-align:middle"><b>Gender</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    ...
    echo '</tr></table></div>';
    */
echo ("leaderboard will be implemented");
}
